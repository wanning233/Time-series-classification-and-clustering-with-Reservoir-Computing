"""
数据集实验：CharacterTrajectories
运行: python3 examples/run_character_trajectories.py
"""
...
DS_NAME  = 'CharacterTrajectories'
DS_LABEL = 'CharacterTrajectories'

# CharacterTrajectories: 2858样本×205步×3特征，20类
# 每类保留50样本（2858→1000），时间步每2帧取1帧（205→103）
_U = 200
